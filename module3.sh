...
# ТВОИ IP для CLIENT_KEY=777 (замени эти строки):

DEF_HQ_SRV_IP="10.52.52.7"      # HQ-SRV
DEF_BR_SRV_IP="10.52.52.52"     # BR-SRV  
DEF_HQ_CLI_IP="10.52.52.2"      # HQ-CLI
DEF_HQ_RTR_IP="172.16.52.2"     # HQ-RTR
DEF_BR_RTR_IP="172.16.89.2"     # BR-RTR
